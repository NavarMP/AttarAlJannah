...
export default function StudentOrderDetailsPage({ params }: { params: Promise<{ id: string }> }) {
    const { id } = use(params);
    ...
    const fetchOrder = useCallback(async () => {
        ...
        try {
            const response = await fetch(`/api/student/orders?studentId=${studentId}&orderId=${id}`);
            if (!response.ok) {
